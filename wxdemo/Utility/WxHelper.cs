...
namespace Utility
{
    public class WxHelper
    {
        ...
        public static ConvertParams GetAccessToken(string appid, string appsecret)
        {
            string data = RequestType.HttpGet("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid="+appid+"&secret="+appsecret);

            ConvertParams model = JsonConvert.DeserializeObject<ConvertParams>(data);
        ...
        public static string Getsignature(string nonceStr, string timespanstr,string accesstoken,string ticketzj,string appid,string appsecret)
        {
           
            string url = HttpContext.Current.Request.Url.ToString();

            string str = "jsapi_ticket=" + (string)ticketzj + "&noncestr=" + nonceStr +
