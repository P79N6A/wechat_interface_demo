<%@ Page Title="上传图文素材" Language="C#" MasterPageFile="~/layout/page.Master" AutoEventWireup="true" CodeBehind="massuploadimgtext.aspx.cs" Inherits="WebApp.page.dialogue.massuploadimgtext" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
     ...
     <div class="content native-scroll" id="page-photo-browser">
        <div class="content-block-title">上传图文素材 <a href="mass.aspx">返回</a></div>
        ...
        <div class="content-block">
            <div class="row" style="margin: 0 auto">
                <div><a href="javascript:void(0)" class="button button-big button-fill button-success" onclick="btn_upload_imgtext()">确定上传</a></div>
            </div>
        </div>
    </div>
</asp:Content>
