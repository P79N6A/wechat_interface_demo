<%@ Page Title="添加二级菜单" Language="C#" MasterPageFile="~/layout/page.Master" AutoEventWireup="true" CodeBehind="menuaddtwo.aspx.cs" Inherits="WebApp.page.dialogue.menuaddtwo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="content native-scroll" id="page-photo-browser">
        <div class="content-block-title">添加二级菜单 <a href="menulist.aspx">返回</a></div>
                ...
                <li>
                    <div class="item-content">
                        <div class="item-inner">
                            ...
                            <div class="item-input">
                                <input type="text" value="" placeholder="最多七个汉子" id="txtmenuname" />
                            </div>
                        </div>
                    </div>
                </li>
